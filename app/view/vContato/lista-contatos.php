...
$apiResponse = file_get_contents('http://localhost/projetos/crmx/api/apiRead/apiListarContatos.php');
$lista_contatos = json_decode($apiResponse, true);

$cadastros = $lista_contatos['data'] ?? [];
