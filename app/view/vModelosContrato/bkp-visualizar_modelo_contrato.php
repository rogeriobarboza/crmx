...
<head>
  ...
  <style>
    ...
    .page-break-marker {
      ...
      position: absolute;
      left: 0;
      height: 45mm; /* altura total: 15mm + linha + 15mm */
      background: white; /* para garantir que cubra o conteúdo */
    }

    .page-break-marker hr {
      border: none;
      border-top: 1px solid #ccc;
      margin: 15mm 0; /* espaçamento vertical antes e depois da linha */
      padding: 0;
      width: 100%;
    }
